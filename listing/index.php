...
<article class="listing">
    ...
    <?php if ($success): ?>
      <div class="alert success">
        ...
        <p><a href="<?php echo BASE_URL ?>/index.php?page=listing&id=<?php echo $listing_id ?>">Go to listing page</a></p>
      </div>

    <?php else: ?>

      <img id="listing-img" src="<?php echo BASE_URL ?>/images/<?php echo $listingData['img_path']; ?>" alt="<?php echo htmlspecialchars($listingData['name']); ?>">
      <div id= "listing-data">
        <h1><?php echo $listingData['name'] ?></h1>

        <p id="listing-seller">Seller: <?php echo htmlspecialchars($listingData['listing_seller'])." (".htmlspecialchars($listingData['listing_seller_uname']).")" ?></p>
        <h2 id="listing-price"><?php echo htmlspecialchars($listingData['price'])."€"?></h2>
        ...
        <div class="listing-comments">
          <h2>Comments</h2>
           ...
           <form action="<?php echo BASE_URL ?>/index.php?page=listing&id=<?php echo $_GET['id']; ?>" method="POST"  class="comment-form">
          ...
          <?php if (!empty($listingComments)): ?>
          <?php foreach ($listingComments as $comment): ?>
